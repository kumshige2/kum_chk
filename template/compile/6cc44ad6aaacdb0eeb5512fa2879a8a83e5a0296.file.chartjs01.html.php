<?php /* Smarty version Smarty-3.1.21, created on 2016-05-24 11:23:36
         compiled from ".\template\chartjs01.html" */ ?>
<?php /*%%SmartyHeaderCode:20155743bb286695e8-11948649%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cc44ad6aaacdb0eeb5512fa2879a8a83e5a0296' => 
    array (
      0 => '.\\template\\chartjs01.html',
      1 => 1463704659,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20155743bb286695e8-11948649',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5743bb287059e5_17895839',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5743bb287059e5_17895839')) {function content_5743bb287059e5_17895839($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
"><i class="fa fa-circle-o"></i> Pace Page</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ChartJS
        <small><?php echo $_smarty_tpl->tpl_vars['res']->value[0][2];
echo $_smarty_tpl->tpl_vars['res']->value[0][3];?>
 </small>
      </h1>
      <ol class="breadcrumb">
      ...
      datasets: [
        {
          ...
          data: [ res[0][8],res[1][8],res[2][8],res[3][8],res[4][8],res[5][8],res[6][8],
		  res[7][8],res[8][8],res[9][8],res[10][8],res[11][8] ]
        },
        {
          label: "Hak",
          ...
          data: [ res[0][11],res[1][11],res[2][11],res[3][11],res[4][11],res[5][11],res[6][11],
		  res[7][11],res[8][11],res[9][11],res[10][11],res[11][11] ]
        }
      ]
    };
...
=name.toLowerCase()st-legend\"><?php echo '<%'; ?>
 for (var i=0; i<datasets.length; i++){st<li><span style=\"background-color:<?php echo '<%'; ?>
=datasets[i].lineColorst\"></span><?php echo '<%'; ?>
if(datasets[i].label){st<?php echo '<%'; ?>
=datasets[i].labelst<?php echo '<%'; ?>
}st</li><?php echo '<%'; ?>
}st</ul>",
    ...
    var pieOptions = {
      ...
      legendTemplate: "<ul class=\"<?php echo '<%'; ?>
=name.toLowerCase()st-legend\"><?php echo '<%'; ?>
 for (var i=0; i<segments.length; i++){st<li><span style=\"background-color:<?php echo '<%'; ?>
=segments[i].fillColorst\"></span><?php echo '<%'; ?>
if(segments[i].label){st<?php echo '<%'; ?>
=segments[i].labelst<?php echo '<%'; ?>
}st</li><?php echo '<%'; ?>
}st</ul>"
    };
...
=name.toLowerCase()st-legend\"><?php echo '<%'; ?>
 for (var i=0; i<datasets.length; i++){st<li><span style=\"background-color:<?php echo '<%'; ?>
=datasets[i].fillColorst\"></span><?php echo '<%'; ?>
if(datasets[i].label){st<?php echo '<%'; ?>
=datasets[i].labelst<?php echo '<%'; ?>
}st</li><?php echo '<%'; ?>
}st</ul>",
