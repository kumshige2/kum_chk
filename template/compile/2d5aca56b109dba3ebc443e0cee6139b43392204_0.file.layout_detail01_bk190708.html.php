<?php
/* Smarty version 3.1.32, created on 2019-07-09 13:55:57
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\layout_detail01_bk190708.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5d241e5d4af037_97854005',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2d5aca56b109dba3ebc443e0cee6139b43392204' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\layout_detail01_bk190708.html',
      1 => 1562293097,
      2 => 'file',
    ),
  ),
...
function content_5d241e5d4af037_97854005 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <form method="post">
              <div class="box-body">
                <div class="form-group">
                    <?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[0][1];?>

                 <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ary_crs_view']->value, 'data', false, 'k');
if ($_from !== null) {
...
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['items']->value;?>
 (項目ID:<span><?php echo $_smarty_tpl->tpl_vars['k']->value;?>
               ...
               <!--   <li class="ui-state-default"><input value="<?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_val']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_val']->value['index'] : null);?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[(isset($_smarty_tpl->tpl_vars['__smarty_section_val']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_val']->value['index'] : null)];?>
 (項目ID:<span><?php echo (isset($_smarty_tpl->tpl_vars['__smarty_section_val']->value['index']) ? $_smarty_tpl->tpl_vars['__smarty_section_val']->value['index'] : null);?>
</span>)</li>
                  <li class="ui-state-default"><input value="c2" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
 (項目ID:<span>2</span>)</li>
                  <li class="ui-state-default"><input value="c3" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['value']->value[2];?>
 (項目ID:<span>3</span>)</li>
                  <li class="ui-state-default"><input value="c4" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['value']->value[3];?>
 (項目ID:<span>4</span>)</li>
                  <li class="ui-state-default"><input value="c5" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['value']->value[4];?>
 (項目ID:<span>5</span>)</li>--->
                  <?php
}
}
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  method="post">
             <div class="box-body">
                <div class="form-group">
                <ul id="jquery-ui-sortable">
                  <li class="ui-state-default"><input value="c1" type="checkbox" class="flat-red" checked>項目名 A (項目ID:<span>1</span>)</li>
                  <li class="ui-state-default"><input value="c2" type="checkbox" class="flat-red" checked>項目名 B (項目ID:<span>2</span>)</li>
                  <li class="ui-state-default"><input value="c3" type="checkbox" class="flat-red" checked>項目名 C (項目ID:<span>3</span>)</li>
                  <li class="ui-state-default"><input value="c4" type="checkbox" class="flat-red" checked>項目名 D (項目ID:<span>4</span>)</li>
                  <li class="ui-state-default"><input value="c5" type="checkbox" class="flat-red" checked>項目名 E (項目ID:<span>5</span>)</li>
                </ul>
                </div>
                <input type="button" id="submitSortable" value="この並び順を送信">
                <?php echo $_smarty_tpl->tpl_vars['form']->value['rec_seq_c']['html'];?>
<!---<input id="aaa" type="text" style='width:100px;'>--->
                <button type="submit" name="postcheck" class="btn btn-success" title='Postcheck' style='width:100px;'>Postcheck</button>
                <input type="button" class="btn btn-default" style='width:100px;height: 30px;'name="details" onClick="postForm1( 'aaaaa')"><?php echo $_smarty_tpl->tpl_vars['form']->value['hidden'];?>
