<?php /* Smarty version Smarty-3.1.18, created on 2015-11-26 09:59:40
         compiled from ".\template\address_setting_meileur01.html" */ ?>
<?php /*%%SmartyHeaderCode:8589563ae1512aa755-35552578%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2f18e5ccbc440982bc82f01f248d103b6c3a0d78' => 
    array (
      0 => '.\\template\\address_setting_meileur01.html',
      1 => 1448499559,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8589563ae1512aa755-35552578',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_563ae15143adb9_75370947',
  'variables' => 
  array (
    'id' => 0,
    'form' => 0,
...
<?php if ($_valid && !is_callable('content_563ae15143adb9_75370947')) {function content_563ae15143adb9_75370947($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?>﻿<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<div id="sidr"> 
   <ul>
    ...
    <li><a><button class="button01 icon edit" type="submit" name="send" style="width:160px; height:30px; ">Update </button>
        </a></li>
    <li><a>
...
'>Return</a></li>
      <li><a><button type="button" class="button01 icon home" style="width:160px; height:30px;" onclick="location.href='index.php?module=adddetail&id=<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
'">Return</button></a></li>
  </ul>
</div>----->
 <!-- Menu Button --->
    ...
    <div class="pricing-plans row">
      <div class="col-lg-3">
        <div class="plan plan-featured radius3">
          ...
          <div class="plan-details" style ="text-align: right" >
            ...
            <div class="success">Etc<?php echo $_smarty_tpl->tpl_vars['form']->value['etc_cost_c']['html'];?>
 </div>
          </div>
      ...
      <div class="col-lg-3">
        <div class="plan plan-featured radius3">
          ...
          <!--<div class="plan-price"> <b>$1</b> / month </div>--->
          <div class="plan-details" style ="text-align: right;back-ground-color:#eeeeee; " >
       ...
       <div class="col-lg-3">
        <div class="plan plan-featured radius3">
          ...
          <!---<div class="plan-price"> <b>$1</b> / month </div>---->
          <div class="plan-details" style ="text-align: right" >
            <div>Page<?php echo $_smarty_tpl->tpl_vars['form']->value['page_tanka_c']['html'];?>
 </div>
            <div>SeiQ_YYMM<?php echo $_smarty_tpl->tpl_vars['form']->value['sekyymm_c']['html'];?>
 </div>
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['html'];?>
</td>
            </tr>
          </thead>
           <tbody>
       ...
       <div class="col-lg-3">
        <div class="plan plan-featured radius3">
          ...
          <div class="plan-details" style ="text-align: right" >
            ...
            <div><?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['html'];?>
 </div>
            <div>SeiQ_YYMM<?php echo $_smarty_tpl->tpl_vars['form']->value['sekyymm_c']['html'];?>
 </div>
