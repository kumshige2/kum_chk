<?php /* Smarty version Smarty-3.1.18, created on 2015-01-29 10:53:59
         compiled from ".\template\address_setting_smint07.html" */ ?>
<?php /*%%SmartyHeaderCode:1643854c888a548b3a5-45048450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d4cf42912579aa1d2b876f4b9793d8689a423e4' => 
    array (
      0 => '.\\template\\address_setting_smint07.html',
      1 => 1422496435,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1643854c888a548b3a5-45048450',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54c888a574a6c7_58609122',
  'variables' => 
  array (
    'form' => 0,
    'error' => 0,
...
<?php if ($_valid && !is_callable('content_54c888a574a6c7_58609122')) {function content_54c888a574a6c7_58609122($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
</a> <a href="#button"><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['send']['html'];?>
</a> <a class="button01">Post comment (link)</a>
        <input class="button01" type="submit" value="Post comment (input)">
        <button class="button01" type="submit">Post comment (button)</button>
        <a href="#button" class="button01 danger icon trash">Delete Pamphlet</a>
        <button class="button01 icon edit" type="submit">Update Pamphlet </button>
