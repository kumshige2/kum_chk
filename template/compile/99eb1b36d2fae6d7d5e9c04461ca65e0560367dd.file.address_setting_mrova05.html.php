<?php /* Smarty version Smarty-3.1.18, created on 2015-05-20 11:40:50
         compiled from ".\template\address_setting_mrova05.html" */ ?>
<?php /*%%SmartyHeaderCode:2849455516086827f22-36049428%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99eb1b36d2fae6d7d5e9c04461ca65e0560367dd' => 
    array (
      0 => '.\\template\\address_setting_mrova05.html',
      1 => 1432089643,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2849455516086827f22-36049428',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_555160869d2835_58926660',
  'variables' => 
  array (
    'title' => 0,
    'h1' => 0,
...
<?php if ($_valid && !is_callable('content_555160869d2835_58926660')) {function content_555160869d2835_58926660($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html>
...
" class="invisible"> <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_fax']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_fax']['index']];?>
   ...
   <span class="span1 i-block"><i class="icon-book"></i></span>
    <div class="container clearfix" style="background-color:#eeeeee">
        ...
        <div class="grid4 first"><h5 style="color:#eee;">部数サイズ</h5>
...
部</td>
        ...
        <div class="grid4"><h5 style="color:#eee;">3等分</h5>
          <table style="color:#999999;">
            <tbody>
            <tr>
                <th>ポスタ</th>
...
部</td>
 ...
 <div class="container clearfix"  style="background-color:#eeeeee">
    <span class="span1 i-block"><i class="icon-print"></i></span>
    <div class="grid4 first"><h4></span>PRINT</h4>
 ...
 <div class="section" id="aboutus3">
    ...
    <div class="title">
        ...
        <span class="span1 i-block"><i class="icon-file"></i></span>
    <div class="container clearfix" style="background-color:#eeeeee">
       <div class="grid4 first" ><h5>本学確認情報</h5>
         <table style="color:#999999;">
        <tbody>
            <tr>
...
Ｐ</th>
    ...
    <span class="span1 i-block"><i class="icon-file"></i></span>
    <div class="container clearfix" style="background-color:#eeeeee">
      <div class="grid3 first" ><h5>他団体確認情報</h5>
    ...
    <div class="grid3"><h5 style="color:#eee;">4等分</h5>
        <table style="color:#999999;">
        <tbody>
            <tr class="on_off">
