<?php /* Smarty version Smarty-3.1.18, created on 2015-01-28 14:34:03
         compiled from ".\template\address_setting_smint06.html" */ ?>
<?php /*%%SmartyHeaderCode:837154c7235d6a7c45-25014072%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d3d903fd1e05a904edf3d377da4aba690e56882' => 
    array (
      0 => '.\\template\\address_setting_smint06.html',
      1 => 1422423239,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '837154c7235d6a7c45-25014072',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54c7235d8da443_53603013',
  'variables' => 
  array (
    'form' => 0,
    'error' => 0,
...
<?php if ($_valid && !is_callable('content_54c7235d8da443_53603013')) {function content_54c7235d8da443_53603013($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
<!-- cool button ----->
<link rel="stylesheet" type="text/css" href="template/css/cool_button01.css">
...
<div class="whole">
  ...
  <div class="plan02">
    <div class="header02"><span>他団体請</span><p class="month02">per month</p>
    </div>
     <div class="header02"><span>産能大掲載</span><p class="month02">per month</p>
    </div>
    <div class="content2">
      <ul class="ul0">
        <li class="li0">　</li>
...
<div class="whole">
  ...
  <div class="plan02">
    <div class="header03"><span>￥5,552,711</span><p class="month02">　</p>
    </div>
    <div class="header03"><span>￥263,887</span><p class="month02">　</p>
    </div>
    <div class="content02">
        <ul class="ul0">
        <li class="li0">　</li>
...
<?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['reset']['html'];?>
   ...
   <a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['test']['html'];?>
</a>
   <a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['test_red']['html'];?>
</a>
   <button class="button00">Button</button>
    </div> <!-- end container --->
