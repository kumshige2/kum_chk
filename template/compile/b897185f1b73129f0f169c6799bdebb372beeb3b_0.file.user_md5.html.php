<?php
/* Smarty version 3.1.32, created on 2019-06-27 13:57:12
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\user_md5.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5d144ca8d9f956_17021172',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b897185f1b73129f0f169c6799bdebb372beeb3b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\user_md5.html',
      1 => 1561611424,
      2 => 'file',
    ),
  ),
...
function content_5d144ca8d9f956_17021172 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="box box-primary">
            ...
            <form method="post">
               ...
               <div class='form-group'>
                 <label>Pass MD5 </label><small>:SHA256</small>
                  <p title="Pass"><?php echo $_smarty_tpl->tpl_vars['form']->value['nko_ymd_c']['html'];?>
</p>
               </div>
              </div>
              <!-- /.box-body -->
              ...
              <div class="box-footer">
                ...
                <button type="submit" name="send0" class="btn btn-primary" title='DownLoad' style='width:100px;'>Check</button>
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  <td><?php echo $_smarty_tpl->tpl_vars['pas_ary']->value[0][0];?>
</td>
                </tr>--->
                <tr>
                  <th>MD5:</th>
                ...
                <tr>
                  <td><?php echo $_smarty_tpl->tpl_vars['pas_ary']->value[0][1];?>
</td>
                </tr>
                <tr>
                  <th>SHA256:</th>
                ...
                <tr>
                  <td><?php echo $_smarty_tpl->tpl_vars['pas_ary']->value[0][2];?>
</td>
                </tr>
                <tr>
                  <th>SHA256 Salt:</th>
                ...
                <tr>
                  <td><?php echo $_smarty_tpl->tpl_vars['pas_ary']->value[0][3];?>
</td>
                </tr>
                </table>
            </div>
        ...
        <div class="col-md-5">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal"  method="post">
              <div class="box-body">
                 <button type="submit" name="send1" class="btn btn-primary" title='PDO' style='width:100px;'>PDO pattern01</button>
              </div>
              <!-- /.box-body -->
              <!-- /.box-footer -->
            </form>
