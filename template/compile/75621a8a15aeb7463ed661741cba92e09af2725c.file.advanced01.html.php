<?php /* Smarty version Smarty-3.1.18, created on 2016-05-19 13:48:38
         compiled from ".\template\advanced01.html" */ ?>
<?php /*%%SmartyHeaderCode:22300573d293eec94d2-20135039%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75621a8a15aeb7463ed661741cba92e09af2725c' => 
    array (
      0 => '.\\template\\advanced01.html',
      1 => 1463633309,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22300573d293eec94d2-20135039',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_573d293f0716d8_35577161',
  'variables' => 
  array (
    'par_id' => 0,
    'ary_bsy' => 0,
...
<?php if ($_valid && !is_callable('content_573d293f0716d8_35577161')) {function content_573d293f0716d8_35577161($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Minimal</label>
                 <?php echo smarty_function_html_options(array('name'=>'bsy_cd','options'=>$_smarty_tpl->tpl_vars['ary_bsy']->value,'class'=>"form-control select2",'style'=>"font-size:12px"),$_smarty_tpl);?>
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="inp01[]" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="inp01[]" data-inputmask="'alias': 'mm/dd/yyyy'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="inp01[]" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="inp01[]" data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" name="inp01[]" data-inputmask="'alias': 'ip'" data-mask>
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group my-colorpicker2">
                  <input type="text" name="inp02[]" class="form-control">
              ...
              <div class="bootstrap-timepicker">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="inp02[]" class="form-control timepicker">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="inp03[]" class="form-control pull-right" id="reservation">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" name="inp03[]" class="form-control pull-right" id="reservationtime">
                </div>
                <!-- /.input group -->
              </div>
              <!-- /.form group -->
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <button type="button" name="inp03[]" class="btn btn-default pull-right" id="daterange-btn">
...
<!-- Select2 -->
<script src="template/AdminLTE-master/plugins/select2/select2.full.min.js"></script>
<!-- InputMask -->
<script src="template/AdminLTE-master/plugins/input-mask/jquery.inputmask.js"></script>
<script src="template/AdminLTE-master/plugins/input-mask/jquery.inputmask.date.extensions.js"></script>
<script src="template/AdminLTE-master/plugins/input-mask/jquery.inputmask.extensions.js"></script>
<!-- date-range-picker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.10.2/moment.min.js"></script>
<script src="template/AdminLTE-master/plugins/daterangepicker/daterangepicker.js"></script>
<!-- bootstrap color picker -->
<script src="template/AdminLTE-master/plugins/colorpicker/bootstrap-colorpicker.min.js"></script>
<!-- bootstrap time picker -->
<script src="template/AdminLTE-master/plugins/timepicker/bootstrap-timepicker.min.js"></script>
<!-- SlimScroll 1.3.0 -->
<script src="template/AdminLTE-master/plugins/slimScroll/jquery.slimscroll.min.js"></script>
<!-- iCheck 1.0.1 -->
<script src="template/AdminLTE-master/plugins/iCheck/icheck.min.js"></script>
<!-- FastClick -->
