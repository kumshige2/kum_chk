<?php /* Smarty version Smarty-3.1.21, created on 2016-05-24 11:48:25
         compiled from ".\template\inline01.html" */ ?>
<?php /*%%SmartyHeaderCode:304535743c0f9871519-32013178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '655f3b74d9f4b19c0694ae96cd92cbbcb4b03105' => 
    array (
      0 => '.\\template\\inline01.html',
      1 => 1463704931,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '304535743c0f9871519-32013178',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5743c0f9921195_56094589',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5743c0f9921195_56094589')) {function content_5743c0f9921195_56094589($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
"><i class="fa fa-circle-o"></i> Pace Page</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Inline Charts
        <small><?php echo $_smarty_tpl->tpl_vars['res']->value[11][2];
echo $_smarty_tpl->tpl_vars['res']->value[11][3];
echo $_smarty_tpl->tpl_vars['res']->value[11][0];?>
</small>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
          ...
          <div class="box box-solid">
            <div class="box-header">
              ...
              <h5 class="box-title">jQuery Knob</h5>
              ...
              <div class="row">
                <div class="col-xs-6 col-md-3 text-center">
                   <input type="text" class="knob" value="30" data-width="90" data-height="90" data-fgColor="#3c8dbc" data-readonly="true">
                     ...
                     <div class="knob-label">通研</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][12];?>
" data-width="90" data-height="90" data-fgColor="#f56954">

                  <div class="knob-label">派遣</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][27];?>
"  data-width="90" data-height="90" data-fgColor="#00a65a">
<!--    <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][15];?>
"  data-min="-150" data-max="150" data-width="90" data-height="90" data-fgColor="#00a65a">--->
                  <div class="knob-label">商品</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][18];?>
" data-width="90" data-height="90" data-fgColor="#00c0ef">

                  <div class="knob-label">受託</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
              ...
              <div class="row">
                <div class="col-xs-6 text-center">
                  <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][21];?>
" data-width="90" data-height="90" data-fgColor="#932ab6">

                  <div class="knob-label">Test</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-6 text-center">
                  <input type="text" class="knob" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][24];?>
" data-width="90" data-height="90" data-fgColor="#39CCCC">

                  <div class="knob-label">講習</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
 ...
 <input type="text" class="knob" value= "<?php echo $_smarty_tpl->tpl_vars['res']->value[11][9];?>
...
" data-thickness="0.1" data-width="90" data-height="90" data-fgColor="#00a65a">
                ...
                <!-- ./col -->
                <div class="col-xs-6 col-md-3 text-center">
                  <input type="text" class="knob" data-thickness="0.2" data-angleArc="250" data-angleOffset="-125" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[11][9];?>
...
';	
	...
	var tuk_rate03 = datas[11][9] * 100;
	//console.log(tuk_rate03);
	//$('#tuk_rate03').val(tuk_rate03);
	//document.getElementById("tuk_rate03").value=tuk_rate03;
