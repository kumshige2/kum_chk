<?php
/* Smarty version 3.1.32, created on 2019-07-11 15:00:18
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\layout_detail01_bk190701_01.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5d26d0726b21a7_93215999',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd459245e125b6edcc1f4bcbd574e45dff1cc0966' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\layout_detail01_bk190701_01.html',
      1 => 1562820952,
      2 => 'file',
    ),
  ),
...
function content_5d26d0726b21a7_93215999 (Smarty_Internal_Template $_smarty_tpl) {
?>  <!DOCTYPE html>
  <!------------------------------------------------>
  <!--  jquery を使用しないSortable drag and drop ----->
  <!------------------------------------------------>
  <!------------------------------------------------>
  <!------------------------------------------------>
  <!------------------------------------------------>
...
>
  ...
  ul#hoge01, #hoge02, #hoge03, #hoge04, #hoge05, #hoge06, #hoge07, #hoge08 {
   list-style-type: none;
      margin: 0 2px;
      margin-left: 10px;
      margin-top: 0px;
  ...
  ul#hoge01 li, #hoge02 li, #hoge03 li, #hoge04 li, #hoge05 li, #hoge06 li, #hoge07 li, #hoge08 li {
    /*--  margin: 3px;--*/
      padding: 0.3em;
    /*-- padding-left: 1em;---*/
      font-size: 13px;
...
.jpg" class="img-circle" alt="User Image"> </div>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h4>Procedure
          <small>:::</small><?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[1];?>
...
"><input value="A<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
...
"><input value="B<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
...
"><input value="C<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
:C<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</li>
                    <?php
}
}
...
"><input value="D<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
:D<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</li>
                    <?php
}
}
...
?>
                  <ul class="jquery-ui-sortable">
                   <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['data']->value, 'items');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['items']->value) {
?>
                     <li class="ui-state-success"><input value="<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['items']->value;?>
 (項目ID:<span><?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</span>)</li>
                    <?php
}
}
...
foreach ($_from as $_smarty_tpl->tpl_vars['items']->value) {
?>
                     <li class="ui-state-default"><input value="<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red" checked><?php echo $_smarty_tpl->tpl_vars['items']->value;?>
 (項目ID:<span><?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</span>)</li>
                    <?php
...
"><input value="E<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red"><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
:E<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</li>
                    <?php
}
}
...
"><input value="F<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red"><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
:F<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</li>
                    <?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                  ...
                  <ul id="hoge07">
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ary_fld07']->value, 'data', false, 'k');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['data']->value) {
?>
                       <?php if ($_smarty_tpl->tpl_vars['data']->value == null) {?> <?php break 1;?> <?php }?>
                        <li class="ui-state-default" id="G<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
"><input value="G<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red"><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
:G<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
</li>
                    <?php
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                   ...
                   <ul id="hoge08">
                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ary_fld08']->value, 'data', false, 'k');
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['data']->value) {
?>
                        <?php if ($_smarty_tpl->tpl_vars['data']->value == null) {?> <?php break 1;?> <?php }?>
                        <li class="ui-state-default" id="H<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
"><input value="H<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
" type="checkbox" class="flat-red"><?php echo $_smarty_tpl->tpl_vars['data']->value;?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                ...
                <!---<input id="result" name="result" />--->
                  <button id="submit" class="btn btn-default" style="width:120px;">submit</button><?php echo $_smarty_tpl->tpl_vars['form']->value['hidden'];?>
...
Sortable.create(hoge02, {
  group: {
    name: "shares",
  },
  animation: 100
});
Sortable.create(hoge03, {
  group: {
    name: "shares",
  },
  animation: 100
...
Sortable.create(hoge04, {
  group: {
    name: "shares",
  },
  animation: 100
});
Sortable.create(hoge05, {
  group: {
    name: "shares",
  },
  animation: 100
...
Sortable.create(hoge06, {
  group: {
    name: "shares",
  },
  animation: 100
});
Sortable.create(hoge07, {
  group: {
    name: "shares",
  },
  animation: 100
...
>
  $(function() {
      $("#hoge01").sortable();
      $("#hoge01").disableSelection();
      $("#hoge02").sortable();
      $("#hoge02").disableSelection();
      $("#hoge03").sortable();
      $("#hoge03").disableSelection();
      $("#hoge04").sortable();
      $("#hoge04").disableSelection();
      $("#hoge05").sortable();
      $("#hoge05").disableSelection();
      $("#hoge06").sortable();
      $("#hoge06").disableSelection();
      $("#hoge07").sortable();
      $("#hoge07").disableSelection();
      $("#hoge08").sortable();
      $("#hoge08").disableSelection();
      $("#submit").click(function() {
          var result = $("#hoge01").sortable("toArray");
          result.push($("#hoge02").sortable("toArray"));
          result.push($("#hoge03").sortable("toArray"));
          result.push($("#hoge04").sortable("toArray"));
          result.push($("#hoge05").sortable("toArray"));
          result.push($("#hoge06").sortable("toArray"));
          result.push($("#hoge07").sortable("toArray"));
          result.push($("#hoge08").sortable("toArray"));
          $("#result").val(result);
          $("form").submit();
