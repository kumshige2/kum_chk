<?php /* Smarty version Smarty-3.1.21, created on 2016-05-24 11:53:24
         compiled from ".\template\datatable01.html" */ ?>
<?php /*%%SmartyHeaderCode:34415743c224ad8799-24200389%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '553a02419615bc06e51b19ac24622b80a1576a59' => 
    array (
  ...
  'nocache_hash' => '34415743c224ad8799-24200389',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5743c224c34215_17851520',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5743c224c34215_17851520')) {function content_5743c224c34215_17851520($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<!---
...
">
        <i class="fa fa-th"></i> <span>Widgets</span>
         <small class="label pull-right bg-green">new</small> </a>
          </li>
...
?>  
              ...
              <tr>
                ...
                <td>
               <!---
               <input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][0];
echo $_smarty_tpl->tpl_vars['konma']->value;
echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][1];
echo $_smarty_tpl->tpl_vars['konma']->value;
echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][2];?>
" name="p_ids" >
                     <button type="submit" name="details" style="width:100px; height:30px;">Edit</button>
                     --->
...
?>
              ...
              <tr>
                ...
                <td> 
                 <input type="button" class="button01 icon tag" name="details" style="width:100px; height:30px;" value="Edit" onClick="postForm('<?php echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][0];
echo $_smarty_tpl->tpl_vars['konma']->value;
echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][1];
echo $_smarty_tpl->tpl_vars['konma']->value;
echo $_smarty_tpl->tpl_vars['res']->value[$_smarty_tpl->getVariable('smarty')->value['section']['i']['index']][2];?>
