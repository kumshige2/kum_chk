<?php
/* Smarty version 3.1.32, created on 2020-03-23 16:51:49
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\juk_knr_syain_dum_view01.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5e786a957e41e7_15113381',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '267d7756771511b3f5af218d213a0adb63fed59f' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\juk_knr_syain_dum_view01.html',
      1 => 1584949884,
      2 => 'file',
    ),
  ),
...
function content_5e786a957e41e7_15113381 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
<!---
...
<?php echo '<script'; ?>
 Language="JavaScript">
//----------------------------
// t_syain_sun_dummy delete
// ---------------------------
// Clear押下
function del01(id){
  var syainno;
  var sts;
  //client_id =document.getElementById("client_id_c-0").textContent;
  //access_id =document.getElementById("access_id_c-0").textContent;
  syainno =document.getElementById("syainno_c-0").textContent;
  sts = 'delxx';
  id = id ',' + syainno + ',' + sts;
  alert(id);
//
  if(confirm('該当  Dummy社員データを削除してもよろしいですか?')!=false){
    document.syain_dum_f1.judge.value="1";
    document.syain_dum_f1.action="index.php?module=juk_knr_syain_dum_view01&id="+id;
    document.syain_dum_f1.submit();
  } else {
    document.syain_dum_f1.judge.value="0";
    document.syain_dum_f1.action="index.php?module=juk_knr_syain_dum_view01&id="+id;
    document.syain_dum_f1.submit();
  }
}
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Dummy Syain View</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           <!--<form  name="data_table_f2" method="post" action="index.php?module=juk_knr_syain_view01">-->
           <form  name="data_table_f2" method="post"> <!-- action="index.php?module=juk_knr_syain_dum_view01">--->
...
?>
              ...
              <tr>
                ...
                <td style="font-size:11px;"><?php echo $_smarty_tpl->tpl_vars['value']->value[4];?>
</td>
                ...
                <td><input type="button" class="btn btn-default" name="details" style="width:40px; height:20px;" value=""  title='編集' onClick="postForm('<?php echo $_smarty_tpl->tpl_vars['client_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['access_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['client_nm']->value;?>
,edt,<?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
')";></td>
  		      	 </tr>
               <!-- onClick="postForm('<?php echo $_smarty_tpl->tpl_vars['client_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['access_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['client_nm']->value;?>
,edt,<?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
')"--->
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="box">
            ...
            <!-- /.box-header -->
            <form class="form-horizontal" name="syain_dum_f1" method="post">
             <?php echo $_smarty_tpl->tpl_vars['form']->value['hidden'];?>

             <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
           <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['ary_syn_edt']->value, 'value2');
$_smarty_tpl->tpl_vars['value2']->index = -1;
if ($_from !== null) {
foreach ($_from as $_smarty_tpl->tpl_vars['value2']->value) {
$_smarty_tpl->tpl_vars['value2']->index++;
$_smarty_tpl->tpl_vars['value2']->first = !$_smarty_tpl->tpl_vars['value2']->index;
$__foreach_value2_2_saved = $_smarty_tpl->tpl_vars['value2'];
?>
               <?php if ($_smarty_tpl->tpl_vars['value2']->first) {?>
              ...
              <?php }?>
              <tr>
                <td><?php echo $_smarty_tpl->tpl_vars['form']->value['syainno_c']['html'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['form']->value['birth_md_c']['html'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['form']->value['license_c']['html'];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['form']->value['filler1_c']['html'];?>
</td>
              </tr>
          <?php
$_smarty_tpl->tpl_vars['value2'] = $__foreach_value2_2_saved;
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              </table>
            ...
            <!--<button type="submit" class="btn btn-warning pull-right" name="del" title='削除' id="btn_del" onClick="del01('<?php echo $_smarty_tpl->tpl_vars['access_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['syainno']->value;?>
,delxx')";>Delete</button>-->
            <button style='width:80px' type="submit" class="btn btn-warning pull-right" id="btn_del" title='削除' name="delxx";>Delete</button>
            <button style='width:80px' type="submit" class="btn btn-info pull-right" id="btn_upd" title='更新' name="rew";>Update</button>
            <button style='width:80px' type="submit" class="btn btn-primary pull-right" id="btn_ins" title='追加' name="ins";>Insert</button>
            <!--<input type="button" class="btn btn-primary pull-right" id="btn_upd" title='更新' name="rew2" value='Update2'
             onClick="postForm('<?php echo $_smarty_tpl->tpl_vars['client_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['access_id']->value;?>
,<?php echo $_smarty_tpl->tpl_vars['client_nm']->value;?>
,rew')";>--->
               <!--- <input type="button" class="btn btn-info pull-right" id="btn_upd" name="btn_upd" value="ボタン５">--->
             <p style='display:none'><?php echo $_smarty_tpl->tpl_vars['form']->value['cre_ymd_c']['html'];?>
</p>
...
echo $_smarty_tpl->tpl_vars['form']->value['bsy_nm_c']['html'];
echo $_smarty_tpl->tpl_vars['form']->value['sts_c']['html'];
echo $_smarty_tpl->tpl_vars['form']->value['company_id_c']['html'];
...
function postForm( value ){
   var form = document.createElement( 'form' );
    ...
    form.setAttribute( 'action' , 'index?module=juk_knr_syain_dum_view01');
