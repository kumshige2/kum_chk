<?php /* Smarty version Smarty-3.1.18, created on 2015-01-08 13:10:20
         compiled from ".\template\address_setting_flexselect01.html" */ ?>
<?php /*%%SmartyHeaderCode:1306054adf18677c960-22237450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd0c118273ead12696c24e02edbc58a069c54e95a' => 
    array (
      0 => '.\\template\\address_setting_flexselect01.html',
      1 => 1420690190,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1306054adf18677c960-22237450',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54adf1867f1c93_91430156',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54adf1867f1c93_91430156')) {function content_54adf1867f1c93_91430156($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN"
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
  <head>
    ...
    <link rel="stylesheet" href="template/flexselect/css/flexselect.css" type="text/css" media="screen" />
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4/jquery.min.js" type="text/javascript"></script>
    <script src="template/flexselect/js/liquidmetal.js" type="text/javascript"></script>
    <script src="template/flexselect/js/jquery.flexselect.js" type="text/javascript"></script>
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        download_url = "http://jquery-flexselect.s3.amazonaws.com/jquery.flexselect-0.6.0.zip";
        $("a.download").attr("href", download_url);

        var president = $("select#president");
        $("#example1").example(president, "dull");
        $("#example1").example(president, "flexselect-optgroup");
  ...
  <body>
    <div id="content">
      ...
      <p>
        It uses the <a href="http://github.com/rmm5t/liquidmetal/">LiquidMetal</a> scoring algorithm to narrow the selection.
      </p>
...
When the form is submitted (with allowMismatch set to true), the original <code>email</code> param will be an empty string and the <code>new_email</code> param will be the value of the text in the input box.
    ...
    <div style="display:none;">
      ...
      <select id="animal" name="animal">
        ...
        <option value="d" disabled="disabled">dinosaur</option>
        ...
        <option value="u" disabled="disabled">unicorn</option>
