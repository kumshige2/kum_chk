<?php /* Smarty version Smarty-3.1.18, created on 2015-06-10 10:56:33
         compiled from ".\template\address_setting_mrova07.html" */ ?>
<?php /*%%SmartyHeaderCode:11890556e539b2cf5e1-11447965%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7723accf6f1d056d38c335b3a145e6ea7c6ddee2' => 
    array (
      0 => '.\\template\\address_setting_mrova07.html',
      1 => 1433899844,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11890556e539b2cf5e1-11447965',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_556e539b792381_78559170',
  'variables' => 
  array (
    'title' => 0,
    'h1' => 0,
...
<?php if ($_valid && !is_callable('content_556e539b792381_78559170')) {function content_556e539b792381_78559170($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html>
      ...
      <div class="container clearfix"  style="background-color:#eeeeee"> <span class="span1 i-block"><i class="icon-print"></i></span>
        <div class="grid4 first">
            ...
            <tbody>
                ...
                <td><input type="checkbox" id="on_off" name="pamph_inf01">  </input> </td>
              </tr>
              </tbody>
          </table>
...
<p class="gotop">
    ...
    <ul>
       ...
       <!--- <li><a href="#"><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['send']['html'];?>
        ...
        <li><a><button class="button01 icon edit" type="submit" name="send" style="width:160px; height:30px; ">Update </button></a></li>
        <li><a><button class="button01 icon add" type="submit" name="new" style="width:160px; height:30px; ">CopyPaste</button></a></li>    
       <!---
        <li><a><button id='button1' type="submit" name="new" style="border:0px;background-color:transparent;cursor:pointer;">CpPaste</button>#CCPP</a></li>
        <li><a><button id='button2' type="submit" name="send" style="border:0px;background-color:transparent;cursor:pointer;">update </button>upd  oLd</a></li>
        <li><a href="javascript:void(0)" onclick="document.form1.submit();return false;">test insert</a>
           <input type=hidden name="new" value="new"></li>
        <li><a href="javascript:void(0)" onclick="document.form1.submit();return false;">test update</a>
           <input type=hidden name="send" value="send"></li>
        <li><a href="" onclick="zikko();return false;">test</a>
           <input type=hidden name="aaa" value="bbb"></li>  --->  
