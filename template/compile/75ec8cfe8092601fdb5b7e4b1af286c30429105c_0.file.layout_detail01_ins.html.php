<?php
/* Smarty version 3.1.32, created on 2019-08-15 14:37:09
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\layout_detail01_ins.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5d54ef85b784e2_34785432',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '75ec8cfe8092601fdb5b7e4b1af286c30429105c' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\layout_detail01_ins.html',
      1 => 1565315168,
      2 => 'file',
    ),
  ),
...
function content_5d54ef85b784e2_34785432 (Smarty_Internal_Template $_smarty_tpl) {
?>  <!DOCTYPE html>
  <!------------------------------------------------>
                ...
                <div class="box-body">
                  <div class="form-group">
                   <ul class="jquery-ui-sortable"  style="width:204px;height:1242px;" id='rec01'>
                      <?php if ($_smarty_tpl->tpl_vars['sts']->value == 'rew') {?> <li class="ui-state-default" id="D<?php echo $_smarty_tpl->tpl_vars['k']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[0];?>
 </li>
                      <?php }?>
                 ...
                 <!---<input type="hidden" id="result" name="result" />--->
                  <input type="hidden" id="result" name="result" />
               <button type="submit" class="btn btn-info pull-right" id="btn_upd" name="upd" onClick="postForm1('upd,<?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[0];?>
,<?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[1];?>
,<?php echo $_smarty_tpl->tpl_vars['ary_crs_view']->value[2];?>
')">Update</button>
               <!---<input type="button" value='submit2' class="btn btn-default" style='width:110px;'name="upd" onClick="postForm1( 'aaaaa')">
 ...
 language="javascript" type="text/javascript">
  ...
  if (window.File && window.FileReader && window.FileList && window.Blob) {
    ...
    var form = document.createElement( 'form' );
      ...
      /*---let js_ary = <?php echo $_smarty_tpl->tpl_vars['ary_json01']->value;?>
;
      input.setAttribute( 'value' , js_ary + ',' + result );
      form.appendChild( input );----*/
      /*--------------------------
      var input01 = document.createElement( 'input' );
      input01.setAttribute( 'type' , 'hidden' );
      input01.setAttribute( 'name' , 'send2' );
      input01.setAttribute( 'value' ,'send2' );
      form.appendChild( input01 );---*/
      /*-------------------------
      form.setAttribute( 'action' , 'index.php?module=layout_detail01');
