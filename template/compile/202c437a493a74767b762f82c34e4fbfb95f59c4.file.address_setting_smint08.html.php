<?php /* Smarty version Smarty-3.1.18, created on 2015-04-10 11:16:01
         compiled from ".\template\address_setting_smint08.html" */ ?>
<?php /*%%SmartyHeaderCode:213954c9948ecfdfa1-23107822%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '202c437a493a74767b762f82c34e4fbfb95f59c4' => 
    array (
      0 => '.\\template\\address_setting_smint08.html',
      1 => 1428568904,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '213954c9948ecfdfa1-23107822',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54c9948f019428_78497304',
  'variables' => 
  array (
    'form' => 0,
    'error' => 0,
...
<?php if ($_valid && !is_callable('content_54c9948f019428_78497304')) {function content_54c9948f019428_78497304($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
<form <?php echo $_smarty_tpl->tpl_vars['form']->value['attributes'];?>
 class="def" method='post'>
  ...
  <div class="section s1">
    ...
    <div class="inner ">
      <h2 >Section 1 </h2>
      <div class='style00'>aaaaa<span></span>
          ...
          <div id="fdw-pricing-table">
            <div class="plan plan1">
              ...
              <ul style="text-align:left">
                <li><a class="signup" style='width:60px'>P_id</a><?php echo $_smarty_tpl->tpl_vars['form']->value['p_id_c']['html'];?>
-<?php echo $_smarty_tpl->tpl_vars['form']->value['p_no_c']['html'];?>
</li>
                <li><a class="signup" style='width:60px'>開 講</a><?php echo $_smarty_tpl->tpl_vars['form']->value['kaiko1_c']['html'];?>
</li>
                <li><a class="signup" style='width:60px'>部 署</a><?php echo $_smarty_tpl->tpl_vars['form']->value['bsy_cd_c']['html'];?>
</li>
                ...
                <li><a class="signup" style='width:56px'>A D</a>
                  <select  name="ad_cd" class="states"  style="width:175px;">
                ...
                <li><a class="signup" style='width:60px'>Type</a><?php echo $_smarty_tpl->tpl_vars['form']->value['pmh_type_c']['html'];?>
</li>
                <li><a class="signup" style='width:60px'>新規継続</a><?php echo $_smarty_tpl->tpl_vars['form']->value['snk_kei_kbn_c']['html'];?>
</li>
                <li><a class="signup" style='width:60px'><?php echo $_smarty_tpl->tpl_vars['form']->value['dantai_cd_knj_c']['label'];?>
</a><?php echo $_smarty_tpl->tpl_vars['form']->value['dantai_cd_knj_c']['html'];?>
</li>
                <li><a class="signup" style='width:60px'>印刷会社</a><?php echo $_smarty_tpl->tpl_vars['form']->value['insatu_kgo_cd_c']['html'];?>
</li>
...
部</li>
            ...
            <div class="plan plan1">
              ...
              <ul style="text-align:left">
                ...
                <li><a class='signup' style='width:60px'>納品日</a><?php echo $_smarty_tpl->tpl_vars['form']->value['deli_ymd_c']['html'];?>
</li>
                <li><a class='signup' style='width:60px'>納品ヶ所</a><?php echo $_smarty_tpl->tpl_vars['form']->value['deli_xx_c']['html'];?>
</li>
                <li><a class='signup' style='width:60px'>団体数</a><?php echo $_smarty_tpl->tpl_vars['form']->value['tdantai_c']['html'];?>
</li>
                <li><a class='signup' style='width:60px'>総コース</a><?php echo $_smarty_tpl->tpl_vars['form']->value['all_crs_c']['html'];?>
</li>
                <li><a class='signup' style='width:60px'>産コース</a><?php echo $_smarty_tpl->tpl_vars['form']->value['sanno_crs_c']['html'];?>
</li>
                <li><a class='signup' style='width:60px'>share</a><?php echo $_smarty_tpl->tpl_vars['form']->value['crs_share_rate_c']['html'];?>
%</li>
              </ul>
            </div>
...
<?php }?></a>
        <a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['reset']['html'];?>
