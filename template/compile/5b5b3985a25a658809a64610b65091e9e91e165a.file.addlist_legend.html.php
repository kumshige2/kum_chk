<?php /* Smarty version Smarty-3.1.18, created on 2014-12-15 18:57:11
         compiled from ".\template\addlist_legend.html" */ ?>
<?php /*%%SmartyHeaderCode:14147548797e8d54379-88341629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b5b3985a25a658809a64610b65091e9e91e165a' => 
    array (
      0 => '.\\template\\addlist_legend.html',
      1 => 1418637383,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14147548797e8d54379-88341629',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_548797e8d9a885_26109345',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548797e8d9a885_26109345')) {function content_548797e8d9a885_26109345($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<!-- Styles -->
<link href="template/legend/css/bootstrap.css" rel="stylesheet">
<link href="template/legend/css/style.css" rel="stylesheet">
<link rel='stylesheet' id='prettyphoto-css'  href="template/legend/css/prettyPhoto.css" type='text/css' media='all'>
...
<link href="template/legend/css/bootstrap-responsive.css" rel="stylesheet">
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
          <script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script>
        <![endif]-->
<!-- Favicon -->
<link rel="shortcut icon" href="template/legend/img/favicon.ico">
<!-- JQuery -->
<script type="text/javascript" src="template/legend/js/jquery.js"></script>
<!-- Load ScrollTo -->
<script type="text/javascript" src="template/legend/js/jquery.scrollTo-1.4.2-min.js"></script>
<!-- Load LocalScroll -->
<script type="text/javascript" src="template/legend/js/jquery.localscroll-1.2.7-min.js"></script>
  ...
  <div class="navbar navbar-inverse navbar-fixed-top">
    <div class="navbar-inner">
      <div class="container"> 
        ...
        <h1 class="brand"><a href="#top">Home</a></h1>
        <!-- Responsive Navbar Part 2: Place all navbar contents you want collapsed withing .navbar-collapse.collapse. -->
        <nav class="pull-right nav-collapse collapse">
          <ul id="menu-main" class="nav">
            <li><a title="portfolio" href="#portfolio">Base</a></li>
            <li><a title="services" href="#services">SeiQ</a></li>
            <li><a title="news" href="#news">Sanno</a></li>
            <li><a title="team" href="#team">≠Sanno</a></li>
            <li><a title="contact" href="#contact">Print</a></li>
          </ul>
        </nav>
      </div>
      <!-- /.container --> 
      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            ...
            <input type="submit" value="Alarm" name="pmh_select">
...
<form name="addlist_f1" method="post" action="index.php">
  ...
  <section id="portfolio" class="single-page scrollblock">
    ...
    <h1 id="folio-headline">Master...</h1>
    <div class="row">
      <div class="span4">
        <div class="mask2"> <a href="template/legend/img/portfolio-01.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-01.jpg" alt=""></a> </div>
        <div class="inside">
          <hgroup>
        ...
        <!-- /.span4 -->
        <div class="span4">
          <div class="mask2"> <a href="template/legend/img/portfolio-02.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-02.jpg" alt=""></a> </div>
          <div class="inside">
            <hgroup>
              <h2>A Book Apart</h2>
            </hgroup>
        ...
        <!-- /.span4 -->
        <div class="span4">
          <div class="mask2"> <a href="template/legend/img/portfolio-03.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-03.jpg" alt=""></a> </div>
          <div class="inside">
            <hgroup>
      ...
      <div class="row">
        <div class="span4">
          <div class="mask2"> <a href="template/legend/img/portfolio-01.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-03.jpg" alt=""></a> </div>
          <div class="inside">
            <hgroup>
              <h2>Ethan Marcotte Design</h2>
            </hgroup>
        ...
        <!-- /.span4 -->
        <div class="span4">
          <div class="mask2"> <a href="template/legend/img/portfolio-02.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-01.jpg" alt=""></a> </div>
          <div class="inside">
            <hgroup>
              <h2>A Book Apart</h2>
            </hgroup>
        ...
        <!-- /.span4 -->
        <div class="span4">
          <div class="mask2"> <a href="template/legend/img/portfolio-03.jpg" rel="prettyPhoto"><img src="template/legend/img/portfolio-02.jpg" alt=""></a> </div>
          <div class="inside">
            <hgroup>
              <h2>Four Rules for Designers</h2>
            </hgroup>
  ...
  <section id="services" class="single-page scrollblock">
    <div class="container">
      ...
      <h1>SeiQ</h1>
      <!-- Four columns -->
       <div><p>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</p></div>
      <div class="row">
        <div class="span3">
  ...
  <section id="news" class="single-page scrollblock">
    <div class="container">
      ...
      <!-- Three columns -->
      <div class="row">
        <article class="span4 post"> <img class="img-news" src="template/legend/img/blog_img-01.jpg" alt="">
          <div class="inside">
        ...
        <!-- /.span4 -->
        <article class="span4 post"> <img class="img-news" src="template/legend/img/blog_img-02.jpg" alt="">
          <div class="inside">
        ...
        <!-- /.span4 -->
        <article class="span4 post"> <img class="img-news" src="template/legend/img/blog_img-03.jpg" alt="">
          <div class="inside">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="span2 offset1">
          <div class="teamalign"> <img class="team-thumb img-circle" src="template/legend/img/portrait-1.jpg" alt=""> </div>
          <h3>Andrew</h3>
          <div class="job-position">web designer</div>
        </div>
        <!-- ./span2 -->
        <div class="span2">
          <div class="teamalign"> <img class="team-thumb img-circle" src="template/legend/img/portrait-2.jpg" alt=""> </div>
          <h3>Stephen</h3>
          <div class="job-position">web developer</div>
        </div>
        <!-- ./span2 -->
        <div class="span2">
          <div class="teamalign"> <img class="team-thumb img-circle" src="template/legend/img/portrait-3.jpg" alt=""> </div>
          <h3>Maria</h3>
          <div class="job-position">graphic designer</div>
        </div>
        <!-- ./span2 -->
        <div class="span2">
          <div class="teamalign"> <img class="team-thumb img-circle" src="template/legend/img/portrait-4.jpg" alt=""> </div>
          <h3>John</h3>
...
<div class="footer-wrapper">
  <div class="container">
    <footer> <small>&copy; 2013 Inbetwin Network. All rights reserved.</small> </footer>
  </div>
  <!-- ./container --> 
</div>
<!-- Loading the javaScript at the end of the page --> 
<script type="text/javascript" src="template/legend/js/bootstrap.js"></script> 
<script type="text/javascript" src="template/legend/js/jquery.prettyPhoto.js"></script> 
<script type="text/javascript" src="template/legend/js/site.js"></script> 
