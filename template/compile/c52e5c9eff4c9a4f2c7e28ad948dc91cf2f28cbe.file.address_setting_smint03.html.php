<?php /* Smarty version Smarty-3.1.18, created on 2015-01-22 12:01:15
         compiled from ".\template\address_setting_smint03.html" */ ?>
<?php /*%%SmartyHeaderCode:242454af69812e0a93-11646685%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c52e5c9eff4c9a4f2c7e28ad948dc91cf2f28cbe' => 
    array (
      0 => '.\\template\\address_setting_smint03.html',
      1 => 1421895671,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '242454af69812e0a93-11646685',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_54af69813977a4_35518198',
  'variables' => 
  array (
    'form' => 0,
    'ary_ad_ids' => 0,
...
<?php if ($_valid && !is_callable('content_54af69813977a4_35518198')) {function content_54af69813977a4_35518198($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
<a class="signup"><?php echo $_smarty_tpl->tpl_vars['form']->value['kaiko1_c']['label'];?>
      ...
      <div class="plan plan2">
        ...
        <table>
          <tr class="on_off">
            ...
            <td><input type="checkbox" id="on_off" name="cansel_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['cansel_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['dan_adr_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="dan_adr_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['dan_adr_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['saij_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="saij_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['saij_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['e_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="e_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['e_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['sku_inf_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="sku_inf_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['sku_inf_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['juryo_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="juryo_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['juryo_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['juko_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="juko_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['juko_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['kmk_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="kmk_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['kmk_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['eig_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="eig_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['eig_chk_c']['html'];?>
</td> </td>
          </tr>
           <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['lbl_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="lbl_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['lbl_chk_c']['html'];?>
</td> </td>
          </tr>
          <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['sku_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="sku_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['sku_chk_c']['html'];?>
</td> </td>
          </tr>
          <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['nani_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="nani_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['nani_chk_c']['html'];?>
</td> </td>
          </tr>
          <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['zai_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="zai_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['zai_chk_c']['html'];?>
</td> </td>
          </tr>
      ...
      <div class="plan plan2">
        ...
        <table>
          ...
          <tr class="on_off">
            ...
            <td><input type="checkbox" id="on_off" name="kyufu_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['kyufu_chk_c']['html'];?>
</td> </td>
          </tr>
          <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['one_p_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="one_p_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['one_p_chk_c']['html'];?>
</td> </td>
          </tr>
          <tr class="on_off">
            <th><label for="on_off"><?php echo $_smarty_tpl->tpl_vars['form']->value['etc_chk_c']['label'];?>
</label></th>
            <td><input type="checkbox" id="on_off" name="etc_chk_c" value=<?php echo $_smarty_tpl->tpl_vars['form']->value['etc_chk_c']['html'];?>
</td> </td>
          </tr>
          </table>
           <a>-----------------------------------</a>
...
<a class="signup"> <?php echo $_smarty_tpl->tpl_vars['form']->value['color_kosei_kbn_c']['label'];?>
</a><?php echo $_smarty_tpl->tpl_vars['form']->value['color_kosei_kbn_c']['html'];?>
</li>
