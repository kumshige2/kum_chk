<?php /* Smarty version Smarty-3.1.18, created on 2016-05-20 14:04:48
         compiled from ".\template\general01.html" */ ?>
<?php /*%%SmartyHeaderCode:16219573bfa38e47282-63420390%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '67bcfc88a98ec8ad90074a5ae03ec66847988c0a' => 
    array (
      0 => '.\\template\\general01.html',
      1 => 1463704983,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16219573bfa38e47282-63420390',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_573bfa38f0a780_44389064',
  'variables' => 
  array (
    'par_id' => 0,
    'ary_bsy' => 0,
...
<?php if ($_valid && !is_callable('content_573bfa38f0a780_44389064')) {function content_573bfa38f0a780_44389064($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Preview <?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[57];?>
:::</small>
      </h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="index.php?module=post_check01"> 
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Email address</label>
                  <input type="email" class="form-control" id="exampleInputEmail1" name="inp01[]" placeholder="Enter email" >
                </div>
                <div class="form-group">
                  <label for="exampleInputPassword1">Password</label>
                  <input type="password" class="form-control" id="exampleInputPassword1" name="inp01[]" placeholder="Password">
                </div>
                <div class="form-group">
              ...
              <div class="box-footer">
                <button type="submit" name="send0" class="btn btn-primary">Submit</button>
                <button type="submit" name="send1" class="btn btn-primary">Submit1</button>
          ...
          <div class="box box-warning">
            ...
            <div class="box-body" >
              <form role="form" method="post" action="index.php?module=post_check01"> 
                ...
                <div class="form-group">
                  <label>Text</label>
                  <input type="text" class="form-control" placeholder="Enter ..." name="inp11[]">
                </div>
                <div class="form-group">
                  <label>Text Disabled</label>
                  <input type="text" class="form-control" placeholder="Enter ..." disabled name="inp11[]">
                </div>

                <!-- textarea -->
                <div class="form-group">
                  <label>Textarea</label>
                  <textarea class="form-control" rows="3" placeholder="Enter ..." name="inp11[]"></textarea>
                </div>
                <div class="form-group">
                  <label>Textarea Disabled</label>
                  <textarea class="form-control" rows="3" placeholder="Enter ..." name="inp11[]" disabled></textarea>
                </div>

                <!-- input states -->
                <div class="form-group has-success">
                  <label class="control-label" for="inputSuccess"><i class="fa fa-check"></i> Input with success</label>
                  <input type="text" class="form-control" id="inputSuccess" name="inp12[]" placeholder="Enter ...">
                </div>
                <div class="form-group has-warning">
                  <label class="control-label" for="inputWarning"><i class="fa fa-bell-o"></i> Input with
                    warning</label>
                  <input type="text" class="form-control" id="inputWarning" name="inp12[]" placeholder="Enter ...">
                </div>
                <div class="form-group has-error">
                  <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> Input with
                    error</label>
                  <input type="text" class="form-control" id="inputError" name="inp13[]" placeholder="Enter ...">
                </div>
                ...
                <div class="form-group">
                  <label>Select</label>
                <?php echo smarty_function_html_options(array('name'=>'bsy_cd','options'=>$_smarty_tpl->tpl_vars['ary_bsy']->value,'class'=>"form-control",'style'=>"font-size:12px"),$_smarty_tpl);?>

                  <!---
                  <select class="form-control" style="font-size:12px">
                    <option></option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[57];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[58];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[59];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[60];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[113];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[131];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[163];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_bsy']->value[186];?>
</option>              
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" disabled style="font-size:12px">
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['sp'];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['sw'];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['tp'];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['tw'];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['xx'];?>
</option>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select multiple class="form-control" style="font-size:12px">
                   <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['sp'];?>
</option>
                    <option><?php echo $_smarty_tpl->tpl_vars['ary_pmh_type']->value['sw'];?>
</option>
 ...
 <button type="submit" name="send2" class="btn btn-primary">Submit2</button>
              </form>
            </div>
            <!-- /.box-body -->
          </div>
