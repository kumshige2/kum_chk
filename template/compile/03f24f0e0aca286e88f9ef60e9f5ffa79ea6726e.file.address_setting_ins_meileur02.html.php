<?php /* Smarty version Smarty-3.1.18, created on 2016-04-14 14:11:24
         compiled from ".\template\address_setting_ins_meileur02.html" */ ?>
<?php /*%%SmartyHeaderCode:10596566545d647ebe7-37228494%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '03f24f0e0aca286e88f9ef60e9f5ffa79ea6726e' => 
    array (
      0 => '.\\template\\address_setting_ins_meileur02.html',
      1 => 1460610651,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10596566545d647ebe7-37228494',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_566545d6904886_54249194',
  'variables' => 
  array (
    'insertflag' => 0,
    'form' => 0,
...
<?php if ($_valid && !is_callable('content_566545d6904886_54249194')) {function content_566545d6904886_54249194($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?>﻿<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<title>Pamphlet NewOrder Insert !</title>
<!-- Stylesheets -->
<!--- meilleur ---->
...
<link type="text/css" href=<?php echo $_smarty_tpl->tpl_vars['insertflag']->value;?>
 rel="stylesheet" id="cssMain">
<!--
<link type="text/css" href="template/meilleur/css/style_kum01.css" rel="stylesheet" id="cssMain">
-->
<!-----select 2 ---->
...
<form <?php echo $_smarty_tpl->tpl_vars['form']->value['attributes'];?>
 class="def" method='post'>    <!----action="index.php?module=address_setting_ins"> --->
...
<header class="header" id="jump">
 ...
 <span style="color:#33cc99;"><?php echo $_smarty_tpl->tpl_vars['msg']->value;?>
</span><span style="color:#C09;"><?php echo $_smarty_tpl->tpl_vars['errmsg']->value;?>
</span></p>    
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['p_nm_c']['html'];?>
      ...
      <div class="collapse navbar-collapse hidden-xs">
        ...
        <ul class="nav navbar-nav navbar-right">
         ...
         <!----
          ...
          <li><a href="#jump6">Other Notes</a></li>
        </ul>
      </div>
      <!-- /.navbar-collapse -->
   ...
   <!---  <li><a href="#jump4" data-toggle="collapse" data-target=".navbar-responsive-collapse"> Team</a></li>
     <li><a href="#jump5" data-toggle="collapse" data-target=".navbar-responsive-collapse"> Clients</a></li>--->
          <li><a href="#jump6" data-toggle="collapse" data-target=".navbar-responsive-collapse"> Other Notes</a></li>
        </ul>
      </div>
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['sek_knr_kbn_nm_c']['html'];?>
</td> 
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>kgo_cd:<?php echo $_smarty_tpl->tpl_vars['form']->value['kgo_cd_c']['html'];?>
</td>
        ...
        <br class="gap-30" /><?php echo $_smarty_tpl->tpl_vars['form']->value['ksy_cd_dummy_c']['html'];?>
...
" id="makerPulldown" style="width:460px; font-size:12px">           
...
" class="invisible"> <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_fax']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_fax']['index']];?>
                   ...
                   <!--
                    <tr id="tr14" class="invisible">
                      <th>Section</th>    
                       <td><?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_a_cd'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_a_cd']);
          ...
          <div class="panel">
            <div class="panel-heading">
              <h3 class="panel-title"> <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion"
                                        href="#collapseTwo">Pamphlet Information <i class="icon-plus"></i><i class="icon-minus"> </i></a> </h3>
            </div>
    ...
    <div class="gallery-control">
      <div data-toggle="buttons">
         <!-- <label class="btn btn-outline filter active" data-filter="phone tablet desktop">--->
          ...
          style ='font-size:18px;width:120px;'>&#931;</a>&nbsp;
          <!--
          <a href="#" id ="goto_seiq_inf01" name="goto_seiq_inf01" class="btn btn-outline btn-lg" style ='font-size:18px;width:120px;'>SeiQ Inf </a>--->
    ...
    <div class="pricing-plans row">
      <div class="col-lg-3">
        <div class="plan radius3">
          <div class="plan-name">
            <h2> <?php echo $_smarty_tpl->tpl_vars['form']->value['last_ndo_c']['html'];?>
</h2>
      ...
      <div class="col-lg-3">
        <div class="plan radius3">
          <div class="plan-name">
            <h2> <?php echo $_smarty_tpl->tpl_vars['form']->value['this_ndo_c']['html'];?>
</h2>
            <p class="muted"> Simple dummy text of the printing and typesetting industry.</p>
          </div>
      ...
      <div class="col-lg-3">
        <div class="plan plan-featured radius3">
          <div class="plan-name">
            <h2> <?php echo $_smarty_tpl->tpl_vars['form']->value['next_ndo_c']['html'];?>
</h2>
            <p class="muted"> Simple dummy text of the printing and typesetting industry.</p>
          </div>
          <div class="plan-price"> <b style='font-size:44px'><?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['html'];?>
</b></div>
          <div class="plan-details01">
            <div> <?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['html'];?>
 </div>
          ...
          <div class="plan-action"> <a href="#" class="btn btn-success btn-block btn-large"><?php echo $_smarty_tpl->tpl_vars['form']->value['nulls_c']['html'];?>
</a> </div>
        </div>
        <div class="visible-xs visible-sm"> <br class="gap-30" />
          <hr class="gap-divider" />
...
<div id="sidr">
  <ul>
    <li><a>
      <button type="button" class="button01 icon home" style="width:140px; height:30px;" onclick="location.href='index.php?module=search'">Return</button>
      </a></li>
   <!--- <li><a href='index.php?module=search'>Return</a></li>
    <li><a href="#">Top</a></li>
...
'>Return</a></li>
    ...
    <li><a>
      <button class="button01 icon edit" type="submit" name="send" style="width:140px; height:30px; " onClick="javascript:double(this)">Insert </button>
      </a></li>
