<?php /* Smarty version Smarty-3.1.18, created on 2015-04-14 17:31:25
         compiled from ".\template\address_setting_smint09.html" */ ?>
<?php /*%%SmartyHeaderCode:5590551ba656ee2e52-88056169%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '92b2f1832ec9e0686f064743781bdc90a8039320' => 
    array (
      0 => '.\\template\\address_setting_smint09.html',
      1 => 1428021794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5590551ba656ee2e52-88056169',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_551ba65733a9c7_25247188',
  'variables' => 
  array (
    'form' => 0,
    'error' => 0,
...
<?php if ($_valid && !is_callable('content_551ba65733a9c7_25247188')) {function content_551ba65733a9c7_25247188($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
　<?php echo $_smarty_tpl->tpl_vars['form']->value['kgo_nm_c']['html'];?>
              ...
              <table>
               <tr class="on_off">
                  <th><a class="signup" style='width:85px'>P_id</a></th>
                  
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['p_id_c']['html'];?>
　<?php echo $_smarty_tpl->tpl_vars['form']->value['kgo_nm_c']['html'];?>
</td>
                 
                  <td><a class="signup" style='width:60px'>特別設定</a></td>
                  <td><input type="checkbox" id="on_off" name="toku_no_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['toku_no_kbn_c']['html'];?>
 </> </td>
                </tr>
              </table>
               ...
               <table>
                <tr class="on_off">
                  <th><a class="signup" style='width:85px; margin-top:1px;'>コース名変更</a></th>
                  <td><input type="checkbox" id="on_off" name="crs_nm_hk_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['crs_nm_hk_kbn_c']['html'];?>
 </> </td>
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['crs_nm_crs_c']['html'];?>
   </td>
                </tr>
                 <tr class="on_off">  
                  <th><a class="signup" style='width:85px; margin-top:1px;'>受講料変更</a></th>
                  <td><input type="checkbox" id="on_off" name="juko_hk_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['juko_hk_kbn_c']['html'];?>
 </> </td>
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['juko_hk_crs_c']['html'];?>
   </td>   
                </tr>
              </table>
              <ul style="text-align:left">
                <li><a class="signup" style='width:85px'>在籍期間</a>
                     <?php echo $_smarty_tpl->tpl_vars['form']->value['zai_f_c']['html'];?>
　<?php echo $_smarty_tpl->tpl_vars['form']->value['zai_mnt_c']['html'];?>
                                     
                </li>
                <li><a class="signup" style='width:85px'>表示在籍</a>
                     <?php echo $_smarty_tpl->tpl_vars['form']->value['hyozai_f_c']['html'];?>
　<?php echo $_smarty_tpl->tpl_vars['form']->value['hyozai_mnt_c']['html'];?>
                                     
                </li>  
                <li><a class="signup" style='width:85px'>優秀期間</a>
                     <?php echo $_smarty_tpl->tpl_vars['form']->value['yusyu_f_c']['html'];?>
　<?php echo $_smarty_tpl->tpl_vars['form']->value['yusyu_mnt_c']['html'];?>
              ...
              <table>
                <tr class="on_off">
                  ...
                  <th><a class="signup" style='width:85px'>掲載外コース</a></th>
                  <td><input type="checkbox" id="on_off" name="keisai_crs_add_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['keisai_crs_add_c']['html'];?>
 </> </td>
                  <th><a class="signup" style='width:85px; margin-left:5px;'>併用払</a></th>
                  <td><input type="checkbox" id="on_off" name="heiyo_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['heiyo_kbn_c']['html'];?>
 </> </td>
                  <th><a class="signup" style='width:85px; margin-left:5px;'>企業コース</a></th>
                  <td><input type="checkbox" id="on_off" name="kigyo_crs_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['kigyo_crs_kbn_c']['html'];?>
 </> </td>
                  <th><a class="signup" style='width:85px; margin-left:5px;'>リポート特</a></th>
                  <td><input type="checkbox" id="on_off" name="rpt_rnh_kbn_c" 
                    selected=<?php echo $_smarty_tpl->tpl_vars['form']->value['rpt_rnh_kbn_c']['html'];?>
 </> </td>  
             ...
             <table>
               <tr>
                  <th> <a class="signup" style='width:85px; height:65px;margin:1px;'>Memo</a></th>
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['otr_t_c']['html'];?>
</td>
                </tr>
             </table>
             <table>
               <tr>
                  <th> <a class="signup" style='width:85px;'>Updymd</a></th>
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['upd_ymd_c']['html'];?>
</td>
                  <th> <a class="signup" style='width:85px; margin-left:5px;'>Creymd</a></th>
                  <td><?php echo $_smarty_tpl->tpl_vars['form']->value['cre_ymd_c']['html'];?>
</td>                  
                </tr>
             </table>
      ...
      <div class="container">
        ...
        <table>
          <tr class="on_off">
            ...
            <td><input type="checkbox" id="on_off" name="order_sht01"  </> </td>
          </tr>
          <tr class="on_off">
        ...
        <div class='order_sheetxx' id='order_sheetxx'> 
          ...
          <td><input type="submit" value="--- Print2 ---" id ="order_sheet01" name="order_sheet01" class="button01" style="width:120px"></td>
          <!--
...
'"   style="width:120px">Return</button>
      ...
      <div style="display: none;"><?php echo $_smarty_tpl->tpl_vars['form']->value['pmh_type_nm_c']['html'];?>
</div>
      <!-- end container  --->
  ...
  <div class="section s5">
    <div class="inner">
      <div class="container">
        ...
        <div class="whole">
          ...
          <div class="plan00">
            <div class="header"> <span><?php echo $_smarty_tpl->tpl_vars['this_year_cost']->value;?>
</span>
        ...
        <div class="whole">
          ...
          <div class="plan02">
            <div class="header02"><span>他団体請求</span>
        ...
        <div class="whole">
          ...
          <div class="plan02">
            <div class="header03"><span><?php echo $_smarty_tpl->tpl_vars['tdan_sek']->value;?>
</span>
              <p class="month02">　</p>
            </div>
            <div class="header03"><span><?php echo $_smarty_tpl->tpl_vars['sanno_keisai_cost']->value;?>
</span>
              <p class="month02">　</p>
            </div>
            <div class="content02">
    ...
    <div class="header2"> <span>$</span>29
      <p class="month2">per month</p>
            ...
            <div class="content03">
              <ul class="ul2">
                <li class="li0"><?php echo $_smarty_tpl->tpl_vars['com_cost']->value;?>
</li>
                <li class="li0"><?php echo $_smarty_tpl->tpl_vars['sho_cost']->value;?>
</li>
                <li class="li0"><?php echo $_smarty_tpl->tpl_vars['etc_cost']->value;?>
</li>
                <li class="li0">　</li>
              </ul>
            </div>
    ...
    <div class="header2"> <span>$</span>29
      <p class="month2">per month</p>
            ...
            <div class="content03">
              <ul class="ul3">
                <li class="li0"><?php echo $_smarty_tpl->tpl_vars['mng_cost']->value;?>
</li>
                <li class="li0"><?php echo $_smarty_tpl->tpl_vars['sanno_cost']->value;?>
</li>
                <li class="li0">　　</li>
                <li class="li0">　　</li>
              </ul>
...
" class="invisible"> <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_fax']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_fax']['index']];?>
        ...
        <a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['insert']['html'];?>
</a><a><?php if ($_smarty_tpl->tpl_vars['insertflag']->value!=true) {?><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['send']['html'];?>
<?php }?></a> <a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['reset']['html'];?>
</a><a><?php echo $_smarty_tpl->tpl_vars['form']->value['buttons']['reset']['html'];?>
</a>
