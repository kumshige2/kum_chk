<?php /* Smarty version Smarty-3.1.18, created on 2015-11-17 14:20:17
         compiled from ".\template\address_setting_devaid.html" */ ?>
<?php /*%%SmartyHeaderCode:16717548fb540d45061-08612729%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bdfc4d81acaf6c8a3f3d32641d849d864a75def4' => 
    array (
      0 => '.\\template\\address_setting_devaid.html',
      1 => 1421631602,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '16717548fb540d45061-08612729',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_548fb540d45064_19100543',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_548fb540d45064_19100543')) {function content_548fb540d45064_19100543($_smarty_tpl) {?><!DOCTYPE html>
...
<!-- Global CSS -->
<link rel="stylesheet" href="template/devaid/assets/plugins/bootstrap/css/bootstrap.min.css">
<!-- Plugins CSS -->
<link rel="stylesheet" href="template/devaid/assets/plugins/font-awesome/css/font-awesome.css">
<link rel="stylesheet" href="template/devaid/assets/plugins/prism/prism.css">
<!-- Theme CSS -->
<link id="theme-style" rel="stylesheet" href="template/devaid/assets/css/styles-3.css">
...
<header id="header" class="header">
  <div class="container">
    <h1 class="logo pull-left"> <a class="scrollto" href="#promo"> <span class="logo-title">devAid</span> </a> </h1>
    <!--//logo-->
...
<section id="promo" class="promo section offset-header">
  <div class="container text-center">
    ...
    <div class="btns"> <a class="btn btn-cta-secondary" href="http://themes.3rdwavemedia.com/" target="_blank">Demo</a> <a class="btn btn-cta-primary" href="http://themes.3rdwavemedia.com/website-templates/devaid-free-bootstrap-theme-developers/" target="_blank">Download</a> </div>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="item col-md-4 col-sm-6 col-xs-12">
        <div class="icon-holder"> <i class="fa fa-heart"></i> </div>
        <div class="content">
      ...
      <!--//item-->
      <div class="item col-md-4 col-sm-6 col-xs-12">
        <div class="icon-holder"> <i class="fa fa-crosshairs"></i> </div>
        <div class="content">
      ...
      <div class="item col-md-4 col-sm-6 col-xs-12">
        <div class="icon-holder"> <i class="fa fa-tablet"></i> </div>
        <div class="content">
      ...
      <!--//item-->
      <div class="item col-md-4 col-sm-6 col-xs-12">
        <div class="icon-holder"> <i class="fa fa-code"></i> </div>
        <div class="content">
      ...
      <!--//item-->
      <div class="item col-md-4 col-sm-6 col-xs-12">
        <div class="icon-holder"> <i class="fa fa-coffee"></i> </div>
        <div class="content">
    ...
    */
    ...
    if( awesome ){
      ...
      <div class="block">
        ...
        <p class="text-center"> <a class="btn btn-cta-primary" href="https://github.com/twbs/bootstrap" target="_blank">More on GitHub</a> </p>
      </div>
      <!--//block--> 
...
<section id="contact" class="contact section has-pattern">
  <div class="container">
    <div class="contact-inner">
      ...
      <p class="intro  text-center">I hope you find this Bootstrap template useful. <br />
        Feel free to get in touch if you have any questions or suggestions.</p>
      <div class="author-message">
        <div class="profile"> <img class="img-responsive" src="template/devaid/assets/images/profile.png" alt="" /> </div>
        <!--//profile-->
        <div class="speech-bubble">
          ...
          <div class="source"> <span class="name"><a href="https://twitter.com/3rdwave_themes" target="_blank">Xiaoying Riley</a></span> <br />
            <span class="title">UX/UI Designer</span> </div>
          <!--//source--> 
        </div>
        <!--//speech-bubble--> 
      </div>
...
<!-- ******FOOTER****** -->
<footer class="footer">
  <div class="container text-center"> <small class="copyright">Designed with <i class="fa fa-heart"></i> by <a href="http://themes.3rdwavemedia.com" target="_blank">Xiaoying Riley</a> for developers</small> </div>
  <!--//container--> 
</footer>
<!--//footer--> 

<!-- Javascript --> 
<script type="text/javascript" src="template/devaid/assets/plugins/jquery-1.11.1.min.js"></script> 
<script type="text/javascript" src="template/devaid/assets/plugins/jquery-migrate-1.2.1.min.js"></script> 
<script type="text/javascript" src="template/devaid/assets/plugins/jquery.easing.1.3.js"></script> 
<script type="text/javascript" src="template/devaid/assets/plugins/bootstrap/js/bootstrap.min.js"></script> 
<script type="text/javascript" src="template/devaid/assets/plugins/jquery-scrollTo/jquery.scrollTo.min.js"></script> 
<script type="text/javascript" src="template/devaid/assets/plugins/prism/prism.js"></script> 
<script type="text/javascript" src="template/devaid/assets/js/main.js"></script>
</body>
</html>
<?php }} ?>
