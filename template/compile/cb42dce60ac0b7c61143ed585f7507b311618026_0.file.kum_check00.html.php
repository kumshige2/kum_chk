<?php
/* Smarty version 3.1.32, created on 2018-11-29 16:17:36
  from 'C:\xampp\htdocs\composer\test\kum_cafe\template\kum_check00.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5bff9290381792_53285777',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cb42dce60ac0b7c61143ed585f7507b311618026' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_cafe\\template\\kum_check00.html',
      1 => 1543470703,
      2 => 'file',
    ),
  ),
...
function content_5bff9290381792_53285777 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
.jpg" class="img-circle" alt="User Image"> </div>
      ...
      <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-table"></i> <span>Check Tables</span>
              <i class="fa fa-angle-left pull-right"></i>
            </a>
            <ul class="treeview-menu">
              <li><a href="index.php?module=kum_check01"><i class="fa fa-circle-o"></i> Count</a></li>
              <li><a href="index.php?module=kum_check02"><i class="fa fa-circle-o"></i> RecentlySQL</a></li>
            </ul>
          </li>
          <!---<li class="treeview"> <a href="index.php"> <i class="fa fa-chevron-left"></i> <span>Return</span></a></li>--->
        </ul>
      </section>
      <!-- /.sidebar -->
    </aside>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <h1> Console <small>for kum...... </small>
        </h1>
        <!---<ol class="breadcrumb">
