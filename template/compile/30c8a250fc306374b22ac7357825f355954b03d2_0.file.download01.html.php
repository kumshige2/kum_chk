<?php
/* Smarty version 3.1.32, created on 2020-05-19 11:08:44
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\download01.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5ec33fac806d03_10927515',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '30c8a250fc306374b22ac7357825f355954b03d2' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\download01.html',
      1 => 1589853617,
      2 => 'file',
    ),
  ),
...
function content_5ec33fac806d03_10927515 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <div class="box box-success">
            <div class="box-header with-border">
              ...
              <div class="box-body">
                <div class='form-group'>
                 <label>Wuhan Virus </label><small></small>
               </div>
                <form method="post">
                <!--<button type="submit" name="apa" class="btn btn-primary" title='Apache Log' style='width:100px;'>Apache Log</button>-使用不可-->
                 <button type="submit" name="wget01" class="btn btn-success" title='wget' style='width:100px;'>Wget Wuhan Inf</button>
                </form>
             </div>
            <!-- /.box-body -->
          </div>
...
<!---<input id="aaa" type="text" style='width:100px;'>--->
                ...
                <input type="button" class="btn btn-default" style='width:100px;height: 30px;'name="details" value="Postchecks" onClick="postForm1( 'aaaaa')">
                <button type="submit" name="sendmail01" class="btn btn-primary" title='sendmail01' style='width:100px;'>Sendmail01</button>
