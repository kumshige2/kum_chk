<?php /* Smarty version Smarty-3.1.18, created on 2014-11-14 11:34:25
         compiled from ".\template\address_setting_ins.html" */ ?>
<?php /*%%SmartyHeaderCode:29649534f24931cd370-45286535%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c2e7a5c96e60f153f165d54a27803cf927c5719c' => 
    array (
      0 => '.\\template\\address_setting_ins.html',
      1 => 1415669152,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29649534f24931cd370-45286535',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_534f24940ed1c0_66163104',
  'variables' => 
  array (
    'title' => 0,
    'form' => 0,
...
<?php if ($_valid && !is_callable('content_534f24940ed1c0_66163104')) {function content_534f24940ed1c0_66163104($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\xampp\\php\\pear\\Smarty\\libs\\plugins\\function.html_options.php';
?><!DOCTYPE html >
...
" class="fancy_sel">
		...
		<dd><?php if ($_smarty_tpl->tpl_vars['form']->value['kgo_cd_c']['required']) {?><font color="red">*</font>  <?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['kgo_cd_c']['label'];?>
...
?>
        ...
        <dd id="basic-usage-demo" name="card_type_kbn" class="fancy_sel"><?php if ($_smarty_tpl->tpl_vars['form']->value['card_type_kbn_c']['required']) {?> <?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['card_type_kbn_c']['label'];?>
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['shoko_sof_ymd_c']['html'];?>
		...
		<dd><?php if ($_smarty_tpl->tpl_vars['form']->value['shoko_return_ymd_c']['required']) {?> <?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['shoko_return_ymd_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['shoko_return_ymd_c']['html'];?>
</dd>
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['upd_ymd_c']['html'];?>
        ...
        <dd><?php if ($_smarty_tpl->tpl_vars['form']->value['cre_ymd_c']['required']) {?> <?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['cre_ymd_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['cre_ymd_c']['html'];?>
</dd>		
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['all_page_c']['html'];?>
</dd>
		<dd><?php echo $_smarty_tpl->tpl_vars['form']->value['com_page_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['com_page_c']['html'];?>
</dd>
		<dd><?php echo $_smarty_tpl->tpl_vars['form']->value['sho_page_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['sho_page_c']['html'];?>
</dd>
        <a>------以下は　参照のみ----(t_pmh_sek01)</a> 
        <dd><?php echo $_smarty_tpl->tpl_vars['form']->value['senyu_page_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['senyu_page_c']['html'];?>
</dd>
        <dd><?php echo $_smarty_tpl->tpl_vars['form']->value['page_tanka_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['page_tanka_c']['html'];?>
</dd>	
        <dd><?php echo $_smarty_tpl->tpl_vars['form']->value['sekyymm_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['sekyymm_c']['html'];?>
</dd>
...
<?php echo $_smarty_tpl->tpl_vars['form']->value['sho_cost_c']['html'];?>
        ...
        <!-- <dd><?php if ($_smarty_tpl->tpl_vars['form']->value['sanno_crs_c']['required']) {?> <?php }?><?php echo $_smarty_tpl->tpl_vars['form']->value['sanno_crs_c']['label'];?>
<?php echo $_smarty_tpl->tpl_vars['form']->value['sanno_crs_c']['html'];?>
</dd> -->
      ...
      <div style="clear: both;"></div>
      <p class="field switch"  ><span>kyufu_chk: </span>  
         
       <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[0]==1) {?>
                  <input type="radio" id="kyufu_chk_on" name="kyufu_chk_c" value =1 checked />  On
                  <input type="radio" id="kyufu_chk_off" name="kyufu_chk_c" value =0 />  Off
      	...
      	<?php } else { ?>
				  <input type="radio" id="kyufu_chk_on" name="kyufu_chk_c" value =1 />  On
                  <input type="radio" id="kyufu_chk_off" name="kyufu_chk_c" value =0 checked />  Off
...
/>
         ...
         <!-- --->
        <p class="field switch"><span>cancel_chk: </span>
         <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[1]==1) {?>
                  <input type="radio" id="cansel_chk_on" name="cansel_chk_c" value =1 checked />  On
                  <input type="radio" id="cansel_chk_off" name="cansel_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="cansel_chk_on" name="cansel_chk_c" value =1 />  On
                  <input type="radio" id="cansel_chk_off" name="cansel_chk_c" value =0 checked />  Off
		...
		<?php }?>        
         ...
         <!-- --->
         <p class="field switch"><span>dan_adr_chk: </span>
         <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[2]==1) {?>
                  <input type="radio" id="dan_adr_chk_on" name="dan_adr_chk_c" value =1 checked />  On
                  <input type="radio" id="dan_adr_chk_off" name="dan_adr_chk_c" value =0 />  Off  
		...
		<?php } else { ?>
				  <input type="radio" id="dan_adr_chk_on" name="dan_adr_chk_c" value =1 />  On
                  <input type="radio" id="dan_adr_chk_off" name="dan_adr_chk_c" value =0 checked />  Off 
        ...
        <!-- --->
         <p class="field switch"><span>zai_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[3]==1) {?>
                  <input type="radio" id="zai_chk_on" name="zai_chk_c" value =1 checked />  On
                  <input type="radio" id="zai_chk_off" name="zai_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="zai_chk_on" name="zai_chk_c" value =1 />  On
                  <input type="radio" id="zai_chk_off" name="zai_chk_c" value =0 checked />  Off
		...
		<?php }?>
         ...
         <p class="field switch"><span>saij_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[4]==1) {?>
                  <input type="radio" id="saij_chk_on" name="saij_chk_c" value =1 checked />  On
                  <input type="radio" id="saij_chk_off" name="saij_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="saij_chk_on" name="saij_chk_c" value =1 />  On
                  <input type="radio" id="saij_chk_off" name="saij_chk_c" value =0 checked />  Off
		...
		<?php }?>
         ...
         <!-- --->
        <p class="field switch"><span>e_adr: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[5]==1) {?>
                  <input type="radio" id="e_chk_on" name="e_chk_c" value =1 checked />  On
                  <input type="radio" id="e_chk_off" name="e_chk_c" value =0 />  Off
                  <label for="e_chk_on" class="cb-enable selected"><span>On</span></label>
                  <label for="e_chk_off" class="cb-disable"><span>Off</span></label>
		<?php } else { ?>
				  <input type="radio" id="e_chk_on" name="e_chk_c" value =1 />  On
                  <input type="radio" id="e_chk_off" name="e_chk_c" value =0 checked />  Off
		...
		<?php }?>
          ...
          <!-- --->
        <p class="field switch"><span>sku_inf_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[6]==1) {?>
                  <input type="radio" id="sku_inf_chk_on" name="sku_inf_chk_c" value =1 checked />  On
                  <input type="radio" id="sku_inf_chk_off" name="sku_inf_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="sku_inf_chk_on" name="sku_inf_chk_c" value =1 />  On
                  <input type="radio" id="sku_inf_chk_off" name="sku_inf_chk_c" value =0 checked />  Off
		...
		<?php }?>
          ...
          <!-- --->
        <p class="field switch"><span>one_p_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[7]==1) {?>
                  <input type="radio" id="one_p_chk_on" name="one_p_chk_c" value =1 checked />  On
                  <input type="radio" id="one_p_chk_off" name="one_p_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="one_p_chk_on" name="one_p_chk_c" value =1 />  On
                  <input type="radio" id="one_p_chk_off" name="one_p_chk_c" value =0 checked />  Off
		...
		<?php }?>
          ...
          <!-- --->
        <p class="field switch"><span>juryo_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[8]==1) {?>
                  <input type="radio" id="juryo_chk_on" name="juryo_chk_c" value =1 checked />  On
                  <input type="radio" id="juryo_chk_off" name="juryo_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="juryo_chk_on" name="juryo_chk_c" value =1 />  On
                  <input type="radio" id="juryo_chk_off" name="juryo_chk_c" value =0 checked />  Off
		...
		<?php }?>
          ...
          <!-- --->
           <!-- --->
         <p class="field switch"><span>juko_chk: </span>
       <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[9]==1) {?>
                  <input type="radio" id="juko_chk_on" name="juko_chk_c" value =1 checked />  On
                  <input type="radio" id="juko_chk_off" name="juko_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="juko_chk_on" name="juko_chk_c" value =1 />  On
                  <input type="radio" id="juko_chk_off" name="juko_chk_c" value =0 checked />  Off
		...
		<?php }?>
         ...
         <!-- --->
         <p class="field switch"><span>eig_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[10]==1) {?>
                  <input type="radio" id="eig_chk_on" name="eig_chk_c" value =1 checked />  On
                  <input type="radio" id="eig_chk_off" name="eig_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="eig_chk_on" name="eig_chk_c" value =1 />  On
                  <input type="radio" id="eig_chk_off" name="eig_chk_c" value =0 checked />  Off
        ...
        <!-- --->
         <p class="field switch"><span>lbl_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[11]==1) {?>
                  <input type="radio" id="lbl_chk_on" name="lbl_chk_c" value =1 checked />  On
                  <input type="radio" id="lbl_chk_off" name="lbl_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="lbl_chk_on" name="lbl_chk_c" value =1 />  On
                  <input type="radio" id="lbl_chk_off" name="lbl_chk_c" value =0 checked />  Off
        ...
        <!-- --->
        <p class="field switch"><span>sku_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[12]==1) {?>
                  <input type="radio" id="sku_chk_on" name="sku_chk_c" value =1 checked />  On
                  <input type="radio" id="sku_chk_off" name="sku_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="sku_chk_on" name="sku_chk_c" value =1 />  On
                  <input type="radio" id="sku_chk_off" name="sku_chk_c" value =0 checked />  Off
        ...
        <!-- --->
         <p class="field switch"><span>nani_chk: </span>
         <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[13]==1) {?>
                  <input type="radio" id="nani_chk_on" name="nani_chk_c" value =1 checked />  On
                  <input type="radio" id="nani_chk_off" name="nani_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="nani_chk_on" name="nani_chk_c" value =1 />  On
                  <input type="radio" id="nani_chk_off" name="nani_chk_c" value =0 checked />  Off
        ...
        <!-- --->
         <p class="field switch"><span>kmk_chk: </span>
         <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[14]==1) {?>
                  <input type="radio" id="kmk_chk_on" name="kmk_chk_c" value =1 checked />  On
                  <input type="radio" id="kmk_chk_off" name="kmk_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="kmk_chk_on" name="kmk_chk_c" value =1 />  On
                  <input type="radio" id="kmk_chk_off" name="kmk_chk_c" value =0 checked />  Off
        ...
        <!-- --->
        <p class="field switch"><span>etc_chk: </span>
        <?php if ($_smarty_tpl->tpl_vars['chk_array']->value[15]==1) {?>
                  <input type="radio" id="etc_chk_on" name="etc_chk_c" value =1 checked />  On
                  <input type="radio" id="etc_chk_off" name="etc_chk_c" value =0 />  Off
		...
		<?php } else { ?>
				  <input type="radio" id="etc_chk_on" name="etc_chk_c" value =1 />  On
                  <input type="radio" id="etc_chk_off" name="etc_chk_c" value =0 checked />  Off
        ...
        <div id="ksy">
         <td width="200" >
        <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['tuk_kgo_nm_j'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['tuk_kgo_nm_j']);
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_nm']->value[$_smarty_tpl->getVariable('smarty')->value['section']['tuk_kgo_nm_j']['index']];?>
</p>
         <!--
...
" /> ---> 
        ...
        <?php endfor; endif; ?> </td>
        <td width="50">
        <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_ken'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_ken']);
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_ken']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_ken']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
        <td width="150">
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_adr1']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_adr1']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
         <td width="150">
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_adr2']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_adr2']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
         <td width="150">
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_adr3']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_adr3']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
         <td width="150">
        <?php if (isset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_tnto_bsy_nm_j'])) unset($_smarty_tpl->tpl_vars['smarty']->value['section']['kgo_tnto_bsy_nm_j']);
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_tnto_bsy']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_tnto_bsy_nm_j']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
        <td width="50">
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_tnto']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_tnto_nm_j']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_tel']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_tel']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
         <td width="50">
...
" class="invisible">
          <?php echo $_smarty_tpl->tpl_vars['ksy_kgo_fax']->value[$_smarty_tpl->getVariable('smarty')->value['section']['kgo_fax']['index']];?>
</p> 
        <?php endfor; endif; ?>  </td>
        </div>
        <!-----
    ...
    <?php if (!isset($_smarty_tpl->tpl_vars['sts'])) $_smarty_tpl->tpl_vars['sts'] = new Smarty_Variable(null);if ($_smarty_tpl->tpl_vars['sts']->value = 'ins') {?>      
       ...
       <!--  <form name="addlist_f1" method="post" action="index.php">
	         <input type="submit" value="Insert " name="new">
        </form>-->
