<?php /* Smarty version Smarty-3.1.21, created on 2016-05-24 11:48:22
         compiled from ".\template\flot01.html" */ ?>
<?php /*%%SmartyHeaderCode:317885743c0f6433619-01899699%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ba55cc03f813c984a2c9480f7fdc6f13507fde5' => 
    array (
  ...
  'nocache_hash' => '317885743c0f6433619-01899699',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5743c0f64c0010_17948484',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5743c0f64c0010_17948484')) {function content_5743c0f64c0010_17948484($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
<!-- FLOT CHARTS -->
<?php echo '<script'; ?>
 src="template/AdminLTE-master/plugins/flot/jquery.flot.min.js"><?php echo '</script'; ?>
>
<!-- FLOT RESIZE PLUGIN - allows the chart to redraw when the window is resized -->
<?php echo '<script'; ?>
 src="template/AdminLTE-master/plugins/flot/jquery.flot.resize.min.js"><?php echo '</script'; ?>
>
<!-- FLOT PIE PLUGIN - also used to draw donut charts -->
<?php echo '<script'; ?>
 src="template/AdminLTE-master/plugins/flot/jquery.flot.pie.min.js"><?php echo '</script'; ?>
>
<!-- FLOT CATEGORIES PLUGIN - Used to draw bar charts -->
<?php echo '<script'; ?>
 src="template/AdminLTE-master/plugins/flot/jquery.flot.categories.min.js"><?php echo '</script'; ?>
>
<!-- Page script -->
<?php echo '<script'; ?>
>
...
';	
    ...
    var bar_data = {
      data: [["通研", res[11][8]], ["派遣", res[11][11]], ["指導",res[11][14]], ["受託",res[11][17]],
	 ["Test",res[11][20]], ["講習会",res[11][23]],["商品",res[11][26]],["雑収",res[11][29]]],
      color: "#3c8dbc"
    };
    ...
    var donutData = [
      {label: "通研", data: res[11][8], color: "#3c8dbc"},
      {label: "派遣", data: res[11][11], color: "#0073b7"},
	  {label: "指導", data: res[11][14], color: "#3c8dbc"},
      {label: "受託", data: res[11][17], color: "#0073b7"},
	  {label: "TEST", data: res[11][21], color: "#3c8dbc"},
      {label: "講習会", data: res[11][24], color: "#0073b7"},
	  {label: "商品", data: res[11][27], color: "#0073b7"},
      {label: "雑収", data: res[11][30], color: "#00c0ef"}
    ];
