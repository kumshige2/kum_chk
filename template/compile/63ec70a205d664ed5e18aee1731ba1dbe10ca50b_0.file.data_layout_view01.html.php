<?php
/* Smarty version 3.1.32, created on 2019-08-23 10:52:17
  from 'C:\xampp\htdocs\composer\test\kum_chk\template\data_layout_view01.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5d5f46d1467620_06288680',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '63ec70a205d664ed5e18aee1731ba1dbe10ca50b' => 
    array (
      0 => 'C:\\xampp\\htdocs\\composer\\test\\kum_chk\\template\\data_layout_view01.html',
      1 => 1566525133,
      2 => 'file',
    ),
  ),
...
function content_5d5f46d1467620_06288680 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
<!---
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Layout View</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           <form  name="data_table_f2" method="post" action="index.php?module=uke_view01">
...
?>
              ...
              <tr>
                ...
                <td title='Layout編集'style='width:250px;'> <a href="index?module=layout_detail02_ins&KEY=rew,<?php echo $_smarty_tpl->tpl_vars['value']->value[0];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[2];?>
" style ="font-weight:700;"><?php echo $_smarty_tpl->tpl_vars['value']->value[3];?>
</a></td>
                <!--<td><?php echo $_smarty_tpl->tpl_vars['value']->value[3];?>
</td>-->
                <td style='width:400px;'><?php echo $_smarty_tpl->tpl_vars['value']->value[4];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['value']->value[5];?>
</td>
                <td><?php echo $_smarty_tpl->tpl_vars['value']->value[6];?>
</td>
                <td title='新規Layout作成'> <a href="index?module=layout_detail02_ins&KEY=ins,<?php echo $_smarty_tpl->tpl_vars['value']->value[0];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[2];?>
" style ="background-color:#ccff99">New...</a></td>
                <!--
                <td>  <input type="button" class="btn btn-info pull-right" style="width:50px; height:20px;" value="" title='Layout作成' onClick="postForm('ins,<?php echo $_smarty_tpl->tpl_vars['value']->value[0];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[1];?>
,<?php echo $_smarty_tpl->tpl_vars['value']->value[2];?>
')";></td>
  		      	 </tr>--->
...
function postForm( value ){
   var form = document.createElement( 'form' );
    ...
    form.setAttribute( 'action' , 'index?module=layout_detail01');
