<?php /* Smarty version Smarty-3.1.18, created on 2018-06-18 17:35:10
         compiled from ".\template\datatable01_01.html" */ ?>
<?php /*%%SmartyHeaderCode:28543572fe51f7e1ec0-50977522%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7da9b50710099c97c59125944d083e030d3c374f' => 
    array (
      0 => '.\\template\\datatable01_01.html',
      1 => 1529304373,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '28543572fe51f7e1ec0-50977522',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.18',
  'unifunc' => 'content_572fe51f84f4c9_25401385',
  'variables' => 
  array (
    'res' => 0,
    'value' => 0,
...
<?php if ($_valid && !is_callable('content_572fe51f84f4c9_25401385')) {function content_572fe51f84f4c9_25401385($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<!---
  ...
  <aside class="main-sidebar"> 
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu">
        ...
        <li> <a href="../widgets.html"> <i class="fa fa-th"></i> <span>Widgets</span> <small class="label pull-right bg-green">new</small> </a> </li>
        ...
        <li> <a href="../mailbox/mailbox.html"> <i class="fa fa-envelope"></i> <span>Mailbox</span> <small class="label pull-right bg-yellow">12</small> </a> </li>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
           <form  name="data_table_f2" method="post" action="index.php?module=download01">  
...
?> 
               ...
               <thead style="background-color:#CCC">
                  <!--  <tr bgcolor="#adff2f">--->
                  <tr>
                    <th style='width:50px;'>shori_ym</th>
                    <th style='width:30px;' title='総合計予算'>All_budg</th>
                    <th style='width:30px;' title='総合計売上'>All_sale</th>
                    <th style='width:10px;' title='総合計%'>%</th>
                    <th style='width:30px;' title='通研予算'>Tuk_budg</th>
                    <th style='width:30px;' title='通研売上'>Tuk_sale</th>
                    <th style='width:10px;' title='通研%'>%</th>
                    <th style='width:30px;' title='派遣予算'>Hak_budg</th>
                    <th style='width:30px;' title='派遣売上'>Hak_sale</th>
                    <th style='width:10px;' title='派遣%'>%</th>
                    <th style='width:30px;' title='指導'>Sid_budg</th>
                    <th style='width:30px;' title='指導売上'>Sid_sale</th>
                    <th style='width:10px;' title='指導%'>%</th>
              ...
              <tr>
                ...
                <td><?php echo $_smarty_tpl->tpl_vars['value']->value[15];?>
</td>
                <td>
                <input type="button" class="button01 icon tag" name="details" style="width:75px; height:30px;" value="DownLoad" onClick="postForm( '<?php echo $_smarty_tpl->tpl_vars['value']->value[0];?>
