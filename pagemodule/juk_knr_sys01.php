...
//print_r($_SESSION);
//echo "</pre>";
class juk_knr_sys01   extends view {
 //$property
 //var $smarty;
  public $pub_rows00;
  public $pub_bsy00;
...
//-------------------------------------------
	...
	//
	$_SESSION[ACCESSID] = $key_array1[1];
	$_SESSION[CLIENTID] = $key_array1[0];
	$_SESSION[CLIENTNM] = $key_array1[2];
	...
	if (!empty($key_array1[1])) {
	  //echo 'yes'.$key_array1[1];
	  $this ->smarty->assign('vis','visible');
	  //$this ->smarty->assign('dis','inline');
	} else {
	//	echo 'no';
	$this ->smarty->assign('vis','hidden');
	//$this ->smarty->assign('dis','none');
    }
//------------------------------------------
//  年度計算
//------------------------------------------
