...
// addlist   class
//===========================================
class upd_check01 extends view  {
  //property
  var $smarty;
  //==========================================
  //  constructor 
  ...
  //---------------------------------------------
   ...
   //	ChromePhp::log('p_id-->' . $p_id .  ':' .$_POST['KEY']);
	...
	if (isset( $_POST['ret01'])) {
	   $this->_redirect('data_layout_view01',$key_array1[1] . ':'. $key_array1[2] );
	 } // end if
	switch (true) {
    case $sts === 'su0':
	  $this -> smarty -> assign('msg01',ADDUPDATEOK);
	  $this -> smarty -> assign('tytle','-- UPDATE --');
  ...
  case $sts === 'su8':
	...
	case $sts === 'sd0':
	  ...
	  $this -> smarty -> assign('tytle','-- DELETE --');
	...
	//$this -> smarty -> assign('tytle','---- UpdateCheck ----');
	$this -> smarty -> assign('p_id', $p_id);
	$this -> smarty -> assign('p_no', $p_no);
    $this -> smarty -> display('upd_check01.html');
  } // end_fucntion
} // end_class
 ?>
