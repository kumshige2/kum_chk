...
$res1 = array();
$ary_crs_view = array();
$res1 = $obj  -> getlist01('select u.p_id,u.p_no_seq,u.kaiko,u.kgo_nm,u.has_ira_ymd,u.has_ymd,u.seq,u.upd_ymd,u.cre_ymd from t_uke as u order by cre_ymd');
...
//$val_array2=  $this ->json_safe_encode($rows);
	...
	$smarty->display('uke_view01.html');
	}// FUNCTION
